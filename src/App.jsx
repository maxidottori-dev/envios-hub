  ...
  return(
    <div style={{background:"#12172a",border:"1px solid #6366f1",borderRadius:"12px",padding:"0.9rem 1rem",marginTop:"2px"}}>
      ...
      <div style={{marginBottom:"0.5rem"}}>
        ...
        <textarea value={e.observaciones||""} onChange={ev=>set("observaciones",ev.target.value)} placeholder="Notas adicionales..." style={{...S.input,display:"block",width:"100%",height:"46px",resize:"vertical",fontSize:"0.8rem"}}/>
      </div>
